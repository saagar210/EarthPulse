...
const SHOWERS: &[ShowerData] = &[
    ...
    ShowerData {
        ...
        zhr: 5,
        velocity_kps: 18.0,
        parent_body: "26P/Grigg-Skjellerup",
    },
    ShowerData {
        name: "Sigma Hydrids",
        peak_month: 12,
